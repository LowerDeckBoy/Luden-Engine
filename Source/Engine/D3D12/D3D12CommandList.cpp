...
namespace Luden
{
	...
	{
		VERIFY_D3D12_RESULT(pDevice->LogicalDevice->CreateCommandList1(pDevice->GetNodeMask(), CommandListType, D3D12_COMMAND_LIST_FLAG_NONE, IID_PPV_ARGS(&m_GraphicsCommandList)));
